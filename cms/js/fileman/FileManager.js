...
Asset.javascript(assetBasePath+ '/js/milkbox/milkbox.js');
Asset.css(assetBasePath+ '/js/milkbox/css/milkbox.css');
Asset.css(assetBasePath+ '/Css/FileManager.css');
Asset.css(assetBasePath+ '/Css/Additions.css');
Asset.javascript(assetBasePath+ '/js/jsGET.js', { events: {load: (function(){ window.fireEvent('jsGETloaded'); }).bind(this)}});
