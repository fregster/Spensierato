...
(function() {
	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			if (s.image)
				h += '<img class="mceIcon" src="../../publicfiles/tiny_mce/' + s.image + '" /></a>';
			else
...
(function() {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			t.iframeHTML = s.doctype + '<html><head xmlns="http://www.w3.org/1999/xhtml"><base href="../../publicfiles/tiny_mce/' + t.documentBaseURI.getURI() + '"></base>';
