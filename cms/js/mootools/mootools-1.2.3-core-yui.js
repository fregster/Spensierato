...
}},after:function(m,l){if(!l.parentNode){alert(l);return;}alert(l);var n=l.nextSibling;(n)?l.parentNode.insertBefore(m,n):l.parentNode.appendChild(m);},bottom:function(m,l){l.appendChild(m);
