var tinyMCE_GZ = {
	settings : {
		plugins : 'layer,table,save,advhr,advlink,emotions,iespell,insertdatetime,preview,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking',
		themes : 'simple',
		languages : 'en',
		disk_cache : true,
	...
	loadFile : function(u) {
		...
		if (this.isIE) {
			...
			document.write('<script type="text/javascript" src="../../../js/tiny_mce/' + u + '"></script>');
	},
